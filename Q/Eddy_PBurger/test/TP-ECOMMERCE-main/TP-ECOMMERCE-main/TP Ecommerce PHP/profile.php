...
<div class="navbar navbar-inverse navbar-fixed-top" style="background-color:#19181f; border-color:#19181f ;height: 60px;">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" style="font-size:20px"><span class="glyphicon glyphicon-user"></span style="font-size:20px"> <?php echo "Hi, ".$_SESSION["name"]; ?></a>
					<ul class="dropdown-menu">
						<li><a href="cart.php" style="text-decoration:none; color:black; font-size:20px"><span class="glyphicon glyphicon-shopping-cart" style="size:20px"><span style="font-size:20px"> Cart</span></a></li>
						<li class="divider"></li>
						<li><a href="index.php" style="text-decoration:none; color:black;">Orders</a></li>
						<li class="divider"></li>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-9">	
				...
				<div class="panel panel-info" id="scroll" style="border-color:#ffff">
			...
			<div class="col-md-12">
				<center>
					<ul class="pagination" id="pageno">
						<li><a href="#" style="background-color:#d2d2c9">1</a></li>
					</ul>
				</center>
			</div>
		</div>
