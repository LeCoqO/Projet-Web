        ...
        <div class="center-div">
            <div id="div_stat" class="block_Menu" style="margin-left: 7%;">
                <div id="div_button_stat" class="sous_block_Menu">
                    <button class="button BoutonAccueil"
                        onclick=window.location.href='Statistique.php'>Statistique</button>
                </div>
            </div>
            <div id="div_Stocks" class="block_Menu">
                <div class="sous_block_Menu">
                    <button class="button BoutonAccueil"
                        onclick=window.location.href='Consult_Stocks.php'>Stocks</button>
                </div>
            </div>
