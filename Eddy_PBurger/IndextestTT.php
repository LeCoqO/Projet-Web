...
<body>
    ...
    <div id="panier" class="panier_fermee" onclick="showPanier()">
        ...
        <div class="styleButPanier">
            <button id="butpanierliv" style="display: none" class="right " ><a href="Page_Livraison.php" class="button-pannier ">Livraison</a></button>
            <button id="butpanieremp" style="display: none" ><a href="Page_AEmporter.php" class="button-pannier">A Emporter</a></button>
        </div>
    </div>
    <div>
